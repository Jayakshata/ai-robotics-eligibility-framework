...
- **ISO 17757:2019** — Earth-moving machinery *and mining* — **Autonomous and semi-autonomous machine system safety (ASAMS)**; the keystone standard covering the autonomous machine + its system + infrastructure across the lifecycle. ISO/TC 127/SC 2. **(de-facto global gate; adopted as AS 17757:2020.)**
- **ISO 19296:2018** — Mining — **Mobile machines working underground — Machine safety** (Type-C standard for LHDs, haulers, dozers). ISO/TC 82.
- **ISO 21815 series** — Earth-moving machinery — **Collision warning and avoidance**: Part 1:2022 (general requirements — detect, warn, intervene by speed-reduction/motion-inhibit); **ISO/TS 21815-2:2021** (on-board **SAE J1939** interface — enables mixed-fleet interoperability); Part 3:2023 (forward/reverse risk zones).
...
- **ATEX (Dir. 2014/34/EU) / IECEx**, built on the **IEC 60079** series — **explosive-atmosphere** certification for gassy/coal mines: **Group I** (methane/coal dust), EPL **Ma/Mb/Mc**. **(hard gate — zone-specific, non-transferable.)**
...
- **WA Code of Practice — Safe Mobile Autonomous Mining** (DEMIRS) and **Queensland QGN33** (autonomous machinery in coal mines) — jurisdictional deployment gates in Australia.
...
- **Valued degrees:** **Mining Engineering** and **Geological/Geotechnical Engineering** rise to first-class alongside robotics/EE/ME/CS; strong programs at **Colorado School of Mines** (mining engineering + a dedicated robotics graduate program), Curtin **WASM**, UNSW, Queensland, McGill, Witwatersrand.
...
**Key sources (2024–2026, verified):** ISO 17757:2019 (iso.org/standard/76126.html) · ISO 19296:2018 (iso.org/standard/64455.html) · ISO 21815-1:2022 (iso.org/standard/77302.html) & ISO/TS 21815-2:2021 (iso.org/standard/77303.html) · EMESRT vehicle-interaction / 9-layer model, Rev 3.0 Sep 2024 (emesrt.org/vehicle-interaction-improvement) · IEC 60079-0 / ATEX-IECEx Group I EPL Ma/Mb/Mc (standards.iteh.ai; atexor.com/knowledgebase/equipment-protection-level) · MSHA 30 CFR Part 18 & Part 36 (ecfr.gov/current/title-30) · WA Code of Practice — Safe Mobile Autonomous Mining (worksafe.wa.gov.au) & Qld QGN33 (rshq.qld.gov.au) · Caterpillar 2,000+ AHS by 2030 (im-mining.com, 2025-11-07) · Komatsu FrontRunner / Nevada Gold Mines & Sandvik AutoMine Surface Fleet 2025 (fortunebusinessinsights.com; mordorintelligence.com) · Pronto–SafeAI acquisition Jul 2025 (finance.yahoo.com) · Epiroc–ASI Mining 2024 (investmets.com) · Emesent Hovermap GPS-denied SLAM (emesent.com) · Rio Tinto/Fortescue Pilbara autonomy (itnews.com.au; robotics247.com).
