...
> **Overlay (Axis B).** Adds domain + regulation + hardware + safety + delta-eligibility on top of the Axis-A capability profiles — it does NOT restate their curricula. `✓` web-verified this pass · `~` to-verify · `⏱` time-sensitive. Sources at end (2024–2026).
...
- **ITAR — USML Category XV (Spacecraft & Related Articles)** — most space robotics is defense-controlled; **hard gate**: work is effectively restricted to U.S. persons. Oct-2024 reforms moved some items to **EAR** (dual-use) and added **License Exception CSA**; "spacecraft" now defined (>100 km altitude).
...
- **NASA technical standards:** **NASA-STD-8719.14A** (Process for Limiting Orbital Debris); **NASA-STD-3001** (human-system standards — crew health/safety); **NPR 8705.2** + **NASA-STD-8719.29** (Human-Rating Requirements — mandate **two-fault tolerance**); **NASA-STD-8739** series (flight-hardware workmanship) `~`.
...
- **Orbital-debris mitigation:** **ISO 24113:2019** (top-level space debris mitigation requirements); **IADC guidelines** + **UN COPUOS** guidelines; **FCC "5-year rule"** — LEO (≤2000 km) post-mission disposal within 5 years (effective Sep 2024), a **U.S. market gate**.
...
**Sources (verified 2024–2026):** ECSS active/long lists & standards — ecss.nl (ECSS-Q-ST-60-15C Rev.1, ECSS-E-ST-70-11C Rev.1, ECSS-Q-ST-80C Rev.2); NASA-STD-8719.14A — everyspec.com/larc.nasa.gov; ISO 24113:2019 — iso.org/standard/72383.html; NPR 8715.24 & COSPAR PP — nodis3.gsfc.nasa.gov, ntrs.nasa.gov; NPR 8705.2 / NASA-STD-3001 human-rating — nasa.gov/human-rating-guidance, nodis3.gsfc.nasa.gov; FCC 5-year rule — fcc.gov, federalregister.gov/documents/2024/08/09/2024-17093; FAA Part 450 — ecfr.gov title-14 part-450, faa.gov; ITAR USML Cat. XV / EAR CSA (Oct 2024) — federalregister.gov/documents/2024/10/23/2024-24091 & 2024-23975, hklaw.com; Outer Space Treaty Art. VI/Artemis Accords — nasa.gov/artemis-accords; CONFERS — satelliteconfers.org; RAD750/RAD5545/HPSC — en.wikipedia.org/wiki/RAD750, baesystems.com, etd.gsfc.nasa.gov, eejournal.com; Perseverance AutoNav — jpl.nasa.gov, science.org/doi/10.1126/scirobotics.adi3099; OSAM/companies — nasa.gov OSAM-1/2, mda.space, factoriesinspace.com, spacedaily.com (GITAI/JAXA), en.wikipedia.org/wiki/Commercial_Lunar_Payload_Services.
