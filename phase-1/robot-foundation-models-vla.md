...
- **Dual-system architectures (slow VLM planner + fast action expert):** NVIDIA **Isaac GR00T N1 → N1.5 → 🆕 N1.6/N1.7** (open humanoid FM; N1.7 is the shipping head) → **N2** `~` (previewed on the **DreamZero** world-action model; *vendor-reported* ~2× new-task success and top of RoboArena — not independently verified) · **Gemini Robotics** + **-ER** → **🆕 1.5 / ER 1.6** (agentic "think-before-act," tool-calling) · **Figure Helix** (commercial dual-system on Figure 03) · **Tesla Optimus Gen 3** (leverages FSD nets).
